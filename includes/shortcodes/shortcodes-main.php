    ...
    if( $atts['defaultcontent'] == false || twitchpress_is_streaming( $atts['channel_id'] ) ) {
        ...
        switch ( $atts['defaultcontent'] ) {
           ...
           case 'video':
                ...
                <div id="twitchpress-embed-everything">
                    <iframe
                        src="https://player.twitch.tv/?video=' . $atts['videoid'] . '&parent=' . twitchpress_embed_parent_string() . '&autoplay=false"
                        height="720"
                        width="1280"
                        allowfullscreen="true">
                    </iframe>        
           ...
           case 'collection':
                ...
                <div id="twitchpress-embed-everything">
                    <iframe
                        src="https://player.twitch.tv/?collection=' . $atts['collectionid'] . '&parent=' . twitchpress_embed_parent_string() . '"
                        height="720"
                        width="1280"
                        allowfullscreen="true">
                    </iframe>        
...
function twitchpress_channel_status_box_shortcode_helix( $atts ) {       
    ...
    // Establish channel ID - can use channels name if ID not already populated
