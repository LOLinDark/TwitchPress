 ...
 */
function twitchpress_add_webhook_meta($webhook_id, $meta_key, $meta_value, $unique = false) {
 ...
 */
function twitchpress_delete_webhook_meta($webhook_id, $meta_key, $meta_value = '') {
 ...
 */
function twitchpress_get_webhook_meta($webhook_id, $key = '', $single = false) {
 ...
 */
function twitchpress_update_webhook_meta($webhook_id, $meta_key, $meta_value, $prev_value = '') {
